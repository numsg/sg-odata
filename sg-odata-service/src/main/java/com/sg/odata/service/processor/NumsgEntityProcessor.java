...
public class NumsgEntityProcessor  implements EntityProcessor {
    ...
    public NumsgEntityProcessor(final NumsgDataProvider dataProvider) {
    ...
    public void readEntity(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType responseFormat) throws ODataApplicationException, ODataLibraryException {
        ...
        * */
        if (segmentCount == 1) {
            ...
            responseEntity =  dataProvider.read(uriInfo, edmFirstEntitySet).getEntities().get(0);
            ...
            if (navSegment instanceof UriResourceNavigation) {
                ...
                Entity sourceEntity = dataProvider.read(uriInfo, edmFirstEntitySet).getEntities().get(0);
